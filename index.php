<?php
/***************** Custom constant **********************/
include './constants/application.php';
include './constants/chat_app.php';
include './constants/privacy.php';
include './constants/status.php';
include './constants/template.php';
include './constants/service_directory.php';
include './constants/healthy_recipes.php';
include './constants/news_app.php';
include './constants/photography.php';
include './constants/blog_app.php';
include './constants/recent_activities.php';
include './constants/general.php';
include './constants/visitors.php';
