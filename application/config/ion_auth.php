...
$config['tables']['app_news_breaking_news_configuration']   = 'app_news_breaking_news_configuration';
$config['tables']['app_news_latest_news_configuration']     = 'app_news_latest_news_configuration';
