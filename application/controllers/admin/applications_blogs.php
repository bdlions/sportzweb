...
class Applications_blogs extends Admin_Controller {
            ...
            if ($this->form_validation->run() == true) {
                ...
                if ($blog_id !== FALSE) {
                    ...
                    if ($category_name != null) {
                        foreach ($category_name as $category_id) {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                if ($this->admin_blog->update_blog($blog_id, $additional_data)) {
                    ...
                    $category_name = $this->input->post('category_name');
                    if ($category_name != null) {
                        foreach ($category_name as $blog_category_id) {
