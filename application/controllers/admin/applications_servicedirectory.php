...
class Applications_servicedirectory extends Admin_Controller{
    public $tmpl = '';
    ...
    function __construct() {
        ...
        else
        {
            ...
            if(array_key_exists(ADMIN_ACCESS_LEVEL_APPLICATION_SERVICE_DIRECTORY_ID.'_'.ADMIN_ACCESS_LEVEL_WRITING, $access_level_mapping))
            {
                $this->data['allow_writing'] = TRUE;  
            }
