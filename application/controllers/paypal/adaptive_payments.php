...
class Adaptive_payments extends CI_Controller 
{
	...
	function Pay()
	{
		...
		$PayRequestFields = array(
                    ...
                    'CancelURL' => base_url(), 									// Required.  The URL to which the sender's browser is redirected if the sender cancels the approval for the payment after logging in to paypal.com.  1024 char max.
                    ...
                    'ReturnURL' => base_url(), 									// Required.  The URL to which the sener's browser is redirected after approvaing a payment on paypal.com.  1024 char max.
                    'ReverseAllParallelPaymentsOnError' => '', 			// Whether to reverse paralel payments if an error occurs with a payment.  Values are:  TRUE, FALSE
                    'SenderEmail' => 'ptpro@sportzweb.com', 								// Sender's email address.  127 char max.
		...
		$Receiver = array(
                    ...
                    'Email' => 'alamgirkabir7@gmail.com', 												// Receiver's email address. 127 char max.
		...
		$AccountIdentifierFields = array(
                    'Email' => 'ptpro@sportzweb.com', 								// Sender's email address.  127 char max.
