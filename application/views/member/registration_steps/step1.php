...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#skip_find_friend").on("click", function() {
            $("#member_profile_step1").removeClass("registration_steps_header_text");
            $("#member_profile_step3").removeClass("registration_steps_header_text");
            $("#member_profile_step2").addClass("registration_steps_header_text");
            kmrSimpleTabs.setStep(1);
        ...
        for(var i = 0; i < special_interests.length; i ++){
            ...
            interest_html_text += '<div class="form-group small_text_dark"><label><input style="padding-top:10px" type="checkbox" onclick="check_all_boxes(this, ' + selected_special_interest.id + ')"><span style="padding-left:5px";vertical-align: text-top;>Select all</span></label></div>'
...
<form id="form-step1">
    ...
    <div class="row">
        <div id="piechart" class="col-md-6">
            <a href="" id="skip_find_friend">Skip this step</a>
        </div>
        <div id="piechart" class="col-md-6">
            <button id="submit_special_interest" class="btn button-custom pull-left">Save & Continue</button>
        </div>
    </div>
</form>
