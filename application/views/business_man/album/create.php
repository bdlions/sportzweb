<div class="col-md-12">
    <div class="row">
        <?php echo form_open_multipart(base_url()."business_album/complete_uploading_album/{$album_id}", "id=fileupload")?>
...
$(function () {
    ...
    var url = '<?php echo base_url()?>business_album/add_photo_in_album/<?php echo $album_id?>';
