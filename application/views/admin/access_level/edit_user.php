...
<div class="col-md-12">    
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php echo form_open("admin/access_level/edit_user/".$user_id, array('id' => 'form_create_user', 'class' => 'form-horizontal')); ?>
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class ="col-md-8" id="unit_dropdown">
                            <?php echo form_dropdown('user_type_list', $user_type_list, $selected_access_type, 'class=form-control id=user_type_list'); ?>
                        </div> 
                    </div> 
                    <div class="form-group">
                        ...
                        <div class ="col-md-8">
                            <?php echo form_input($user_password+array('class'=>'form-control')); ?>
                        </div> 
                    </div>
                </div>
				...
				<td>
                    ...
                    <div class="form-group">
                        ...
                        <div class ="col-md-3 col-md-offset-3">
                            <?php echo form_input($submit_update_user+array('class'=>'form-control btn button-custom')); ?>
                        </div> 
                    </div>
                </div>
            <?php echo form_close(); ?>
