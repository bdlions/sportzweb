                        ...
                        <div class ="col-md-10 margin-top-bottom">
                            ...
                            <div class="form-group">
                                <label for="type" class="col-md-10 control-label">
                                    Please upload an image at least Height: 1920px and Width: 2560px for better resolution
                                </label>
                            </div>
                            <div class="form-group">
...
$(function () {
    ...
    var url = "<?php echo base_url();?>admin/configure_logout_page/edit_config",
    ...
    $('#fileupload').fileupload({
      ...
      //s  alert(data.result.message);
       var message = data.result.message;
        print_common_message(message);
        window.location = '<?php echo base_url();?>admin/configure_logout_page/edit_config';
