                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="width: 100%;"><!--actual comment-->
                                                    ...
                                                    <div>
                                                        <?php echo unix_to_human($comment['created_on'])?>
                                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div id="like_star_<?php echo $comment['comment_id'] ?>" align="right">
                                                        <img id="" value="<?php echo $comment['comment_id'] ?>" style="padding-bottom: 4px;"src="<?php echo base_url(); ?>resources/images/vote_star_gray_32.png" />
                                                        <?php //}?>                                                        
                                                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div id="like_star_{%= application_comment_info.comment_id %}" align="right">
                                                <img id="" value="{%= application_comment_info.comment_id %}" style="padding-bottom: 4px;"src="<?php echo base_url(); ?>resources/images/vote_star_gray_32.png" />                                                 
                                        </div>
                                    </td>
                                    <td>
