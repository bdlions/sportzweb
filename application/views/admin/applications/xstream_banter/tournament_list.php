    ...
    <div class="panel-body">
        <div class="row col-md-12">            
            <div class="row form-group" style="padding-left: 10px;">
                ...
                <?php } ?>
                <div class ="col-md-2 pull-left">
                    <a href="<?php echo base_url()."admin/applications_xstreambanter/manage_teams/".$sports_id; ?>">
                ...
                <div class="table-responsive table-left-padding">
                    <table class="table table-bordered">
                        ...
                        <tbody id="tbody_tournament_list">                
                            ...
                            <tr>
                                <td style="text-align: center"><a href="<?php echo base_url()."admin/applications_xstreambanter/manage_matches/".$tournament['tournament_id']; ?>"><?php echo $tournament['tournament_id']?></a></td>
...
<?php 
$this->load->view("admin/applications/xstream_banter/modal/tournament_create");
$this->load->view("admin/applications/xstream_banter/modal/tournament_update");
$this->load->view("admin/applications/xstream_banter/modal/tournament_delete_confirm");
?>