...
<script type="text/x-tmpl" id="tmpl_sports_list">
    ...
    {% while(sports_info){ %}
    <tr>
        <td><a href="<?php echo base_url()."admin/application/xstream_banter_sports/{%= sports_info.id%}"; ?>">{%= sports_info.title%}</a></td>
        ...
        <div class="row col-md-12">
            <div class="row form-group">
                ...
                <div class ="col-sm-2 pull-right">
                    <a href="<?php echo base_url();?>admin/application/page_import_xstream">
                ...
                <div class="table-responsive table-left-padding">
                    <table class="table table-bordered">
                        ...
                        <tbody id="tbody_sports_list">                
                            ...
                            <tr>
                                <td><a href="<?php echo base_url()."admin/application/xstream_banter_sports/".$sports['id']; ?>"><?php echo $sports['title']?></a></td>
