...
<script type="text/javascript">
    $(document).ready(function() {
        $("#form_create_recipe").on("submit", function(){
...
<div class="panel panel-default">
    ...
    <div class="row form-horizontal form-background top-bottom-padding">  
        <?php echo form_open_multipart("admin/healthyrecipes/create_recipe/".$recipe_category_id, array('id' => 'form_create_recipe', 'class' => 'form-horizontal')); ?>
        <div class="row">
