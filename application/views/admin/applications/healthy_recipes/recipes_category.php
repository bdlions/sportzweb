...
<script type="text/x-tmpl" id="tmpl_recipes_category_list">
    ...
    <tr>
        <td><a href="<?php echo base_url()."admin/healthyrecipes/recipe_category/{%= recipe_category_info.id%}"; ?>">{%= recipe_category_info.id%}</td>
    ...
    <div class="panel-body">
        <div class="row col-md-12">
            <div class="row form-group">
                <?php if($allow_access): ?>
                    <div class ="col-sm-5">
                        <a href="<?php echo base_url();?>admin/healthyrecipes/page_import_recipe">
                ...
                <?php if($allow_access): ?>
                    <div class =" col-sm-4">
                        <a href="<?php echo base_url().'admin/healthyrecipes/all_recipe_list' ?>">
                ...
                <div class="table-responsive table-left-padding">
                    <table class="table table-bordered" style="text-align: center;">
                        ...
                        <tbody id="tbody_recipes_category_list">
                            ...
                            <tr>
                                <td><a href="<?php echo base_url().'admin/healthyrecipes/recipe_category/'.$recipes_category['id']?>"><?php echo $recipes_category['id']; ?></a></td>
                                <td><div id="recipe_desc_<?php echo $recipes_category['id'];?>"><?php echo $recipes_category['description']?></div></td>
                                <!--<td><a href="<?php echo base_url()."admin/application/healthy_recipes_category/".$recipes_category['id']; ?>">Edit</a></td>-->
