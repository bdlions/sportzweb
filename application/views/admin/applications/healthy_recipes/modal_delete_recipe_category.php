<script type="text/javascript">
    $(function() {
        $("#button_delete").on("click", function() {
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_healthyrecipes/delete_recipe_category",
                data: {
    ...
    function open_modal_delete_recipe_category(recipe_category_id) {
        $('#input_recipe_category_id').val(recipe_category_id);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Delete Recipe Category</h4>
            </div>
            <div class="modal-body">
                <div class="row form-group">
                    <div class ="col-md-offset-2 col-md-10">
                        <span style="font-size: 16px">Are you sure to delete this recipe category?</span>
