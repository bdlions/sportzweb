                ...
                <div class ="col-md-offset-3 col-md-5 margin-top-bottom">
                    ...
                    <div class="form-group">
                        <div class="pull-right col-md-4">
                            <button id="btnSubmit" class="btn button-custom pull-right">Update Match</button>
                        </div>
                    </div>
                </div>
            </div>
 ...
 $(function() {
    ...
    $("#btnSubmit").on("click", function(){
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url();?>admin/applications_scoreprediction/update_match/<?php echo $match_id?>',
            data: $("#form_create_match").serializeArray(),
            success: function(data) {
                alert(data.message);
                window.location = '<?php echo base_url();?>admin/applications_scoreprediction/manage_matches/<?php echo $match_id?>';
            }
        });
    });
});
