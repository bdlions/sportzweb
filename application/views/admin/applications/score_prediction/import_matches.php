    ...
    <div class="panel-body">
        <div>
            ...
            <div class="col-md-8" style="border: 2px dotted #999; padding: 32px;">
                <a href="<?php echo base_url();?>resources/import/applications/score_prediction/sp_sample.xlsx"><button class="btn btn-info pull-right">Download sample</button></a>
                <div id="progress">
                    <?php echo form_open_multipart('admin/applications_scoreprediction/import_matches', array('name'=>'file_upload'));?>
