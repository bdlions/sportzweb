<script type="text/javascript">
    $(function() {
        $("#button_update").on("click", function() {
            ...
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_gympro/update_clients",
                data: {
    ...
    function open_modal_update(id) {
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url(); ?>' + "admin/applications_gympro/get_clients_info",
            data: {
                id: id
            },
            success: function(data) {
                $('#input_update_id').val(data.clients_info['id']);
                $('#input_update_title').val(data.clients_info['first_name']);
                $('#input_update_pricing').val(data.clients_info['last_name']);
