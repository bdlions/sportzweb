<script type="text/javascript">
    $(function() {
        $("#button_create").on("click", function() {
            ...
            {
                //alert("Please assign Health Questions name");
                var message = "Please assign Health Questions name";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Create health questions</h4>
            </div>
            <div class="modal-body">
                <div class="row form-group">
                    <div class ="col-sm-2"></div>
                    <label class="col-sm-3 control-label">Health Question:</label>
                    <div class ="col-sm-4">
