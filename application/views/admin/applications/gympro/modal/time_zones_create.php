<script type="text/javascript">
    $(function() {
        $("#button_create").on("click", function() {
            ...
            {
               // alert("Please assign time zone name");
               var message = "Please assign time zone nam";
            ...
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_gympro/create_time_zones",
                data: {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Create time zones</h4>
            </div>
            <div class="modal-body">
                <div class="row form-group">
                    <div class ="col-sm-2"></div>
                    <label class="col-sm-3 control-label">Time zone Title:</label>
                    <div class ="col-sm-4">
