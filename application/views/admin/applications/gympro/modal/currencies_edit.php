<script type="text/javascript">
    $(function() {
        $("#button_update").on("click", function() {
            ...
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_gympro/update_currencies",
                data: {
    ...
    function open_modal_update(id) {
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url(); ?>' + "admin/applications_gympro/get_currencies_info",
            data: {
                id: id
            },
            success: function(data) {
                $('#input_update_id').val(data.currencies_info['id']);
                $('#input_update_title').val(data.currencies_info['title']);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Update currencies</h4>
            </div>
