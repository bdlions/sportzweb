<div class="panel panel-default" style="margin-top: 30px">
   ...
   <div class="panel-body">
        ...
        <?php endif; ?>
        <?php echo form_open("admin/applications_gympro/create_session_cost", array('id' => 'form_cost', 'class' => 'form-horizontal')); ?>
        ...
        <div class="row form-group">
            <div class="col-sm-offset-5 col-sm-2">
                <?php echo form_input($create_cost_button + array('class' => 'form-control btn button-custom'));?>
            </div>
        </div>
        <?php echo form_close(); ?>
        <div class="row">
            <div class="col-sm-2">
                <a href="<?php echo base_url();?>admin/applications_gympro/session_cost_list">
