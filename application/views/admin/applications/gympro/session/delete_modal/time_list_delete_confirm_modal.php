    ...
    $(function() {
        $("#button_delete").on("click", function() {
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_gympro/delete_session_time",
                data: {
                    time_id: $("#input_time_id").val()
                },
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        ...
                        <input id="input_time_id" name="input_time_id" value="" type="hidden" class="form-control"/>
                    </div>
                </div>                
            </div>
