    ...
    $(function() {
        $("#button_delete").on("click", function() {
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_gympro/delete_session_status",
                data: {
                    status_id: $("#input_status_id").val()
                },
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        ...
                        <label class="col-sm-10 control-label">Are you sure to delete this Status?</label>
                        <input id="input_status_id" name="input_status_id" value="" type="hidden" class="form-control"/>
                    </div>
                </div>                
            </div>
