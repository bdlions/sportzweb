    ...
    <div class="panel-body">
        ...
        <div class="row form-group">
            <div class ="col-md-3 pull-left">
                <button onclick="open_modal_create()" class="form-control btn button-custom">Create Review</button>
            </div>
        </div>
        <?php } ?>
        <div class="row">
...
<?php 
$this->load->view("admin/applications/gympro/modal/reviews_create");
$this->load->view("admin/applications/gympro/modal/reviews_edit");
$this->load->view("admin/applications/gympro/modal/reviews_delete_confirm");
?>
