<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row form-horizontal form-background top-bottom-padding">  
            <form id="formsubmit" method="post" action="<?php echo base_url();?>admin/applications_servicedirectory/create_service/<?php echo $service_category_id?>" onsubmit="return false;">
            <div class="row">
...
$(function () {
    ...
    var url = "<?php echo base_url();?>admin/applications_servicedirectory/create_service/<?php echo $service_category_id?>",
