            ...
            <div class ="col-md-10 margin-top-bottom">
                ...
                <div class="form-group">
                    ...
                    <div class ="col-md-6">
                        ...
                        <input type="hidden" name="service_category_id" id="service_category_id" value="<?php echo $service_info['service_category_id'] ; ?>">
                    </div> 
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class ="col-md-6">
                        <?php if($business_profile_list != NULL) : ?>
                            <?php echo form_dropdown('country_name', $country_list, $selected_country_id,'class=form-control'); ?>
                            <?php else : ?>
                            <?php echo form_dropdown('country_name', $country_list+array('' => 'Select'), '', 'class=form-control'); ?>
                        <?php endif; ?>
                                ...
                                <div class="profile-picture-box" >
                                    <div id="files" class="files">
                                        <?php if(!empty($service_info['picture'])): ?>
                                            <img style="width: 120px; height: 120px;" src="<?php echo base_url() . SERVICE_IMAGE_PATH . $service_info['picture']; ?>" class="img-responsive"/>
                                        <?php endif; ?>
                                            <br>
                                    </div>
                                </div>
