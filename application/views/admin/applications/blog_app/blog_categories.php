...
<script type="text/x-tmpl" id="tmpl_blog_category_list">
    ...
    <tr>
        <td><a href="<?php echo base_url() . "admin/blogapp/blog_list/{%= blog_category_info.id%}"; ?>">{%= blog_category_info.id%}</td>
    ...
    <div class="panel-body">
            <div class="row col-md-12">
                <div class="row form-group">
                    <?php if ($allow_access): ?>
                        <div class ="col-sm-3">
                            <a href="<?php echo base_url(); ?>admin/blogapp/page_import_blogs">
                                <button class="btn button-custom pull-right">Import Blogs</button>
                            </a>
                        </div>
                        <div class ="col-sm-3">
                            <a href="<?php echo base_url(); ?>admin/blogapp/approve_blog">
                                <button id="" value="" class="btn button-custom pull-right">Approve Blogs</button>  
                            </a>
                        </div>
                        <div class ="col-sm-3">
                            <a href="<?php echo base_url(); ?>admin/blogapp/config_blog">
                        ...
                        <table class="table table-bordered" style="text-align: center;">
                            ...
                            <tbody id="tbody_blog_category_list">
                                <?php foreach ($category_list as $row): ?>
                                    <tr>
                                        <td><a href="<?php echo base_url() . 'admin/blogapp/blog_list/' . $row['id'] ?>"><?php echo $row['id']; ?></a></td>
