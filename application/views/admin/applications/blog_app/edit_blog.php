    ...
    $(function() {
        $("#btnSubmit").on("click", function() {
            ...
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>admin/applications_blogs/edit_blog/<?php echo $blog_info['blog_id']; ?>',
                data: $("#formsubmit").serializeArray(),
                success: function(data) {
                  //  alert(data.message);
                  var message = data.message;
                  print_common_message(message);
                    window.location = '<?php echo base_url(); ?>admin/applications_blogs/edit_blog/<?php echo $blog_info['blog_id']; ?>';
                }
            });
        });
        // Change this to the location of your server-side upload handler:
        var url = "<?php echo base_url(); ?>admin/applications_blogs/edit_blog/<?php echo $blog_info['blog_id']; ?>",
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row form-horizontal form-background top-bottom-padding">  
            <?php echo form_open("admin/applications_blogs/edit_blog/".$blog_info['blog_id'], array('id' => 'formsubmit', 'class' => 'form-horizontal', 'onsubmit' => 'return false;'))?>
                <div class="row">
                    <div class ="col-md-10 margin-top-bottom">
                        ...
                        <div class="form-group">
                            ...
                            <div class ="col-md-9">
                                <?php echo form_dropdown('reference_list',$app_item_reference_list, $blog_info['ref_id'], 'class=form-control id=reference_list'); ?>
                            </div> 
                        </div>
                        <div class="form-group">
                            ...
                            <div class ="col-md-9">
                                ...
                                ?>
                                    <div class="col-md-4">
                                        <input <?php echo(in_array($blog_category_info['blog_category_id'], $blog_category_id_list)) ? 'checked=""' : '' ;?> class="category_id" name="category_name[]" type="checkbox" id="<?php echo $blog_category_info['blog_category_id']?>" value="<?php echo $blog_category_info['blog_category_id']?>"/>
