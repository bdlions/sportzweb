    ...
    <div class="panel-body">
        <div class="row col-md-9">
            <div class="row" style="padding-bottom: 20px"><!--Greatest news-->
                <div class="col-md-6 col-lg-6">
                    <?php //if (array_key_exists(0, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url() ?>applications/news_app/news_item/<?php if (array_key_exists(0, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[0]]['news_id']; }?>">
            ...
            <div class="row" style="padding-bottom: 20px"><!--top news loop...3 news per row-->
                <div class="col-md-4 col-lg-4">
                    ...
                    <?php //if (array_key_exists(1, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(1, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[1]]['news_id']; }?>">
                ...
                <div class="col-md-4 col-lg-4">
                    ...
                    <?php //if (array_key_exists(2, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(2, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[2]]['news_id']; }?>">
                ...
                <div class="col-md-4 col-lg-4">
                    ...
                    <input type="hidden" name="position_of_news_4" id="position_of_news_4" value="<?php echo (array_key_exists(3, $region_id_news_id_map)) ? $news_id_news_info_map[$region_id_news_id_map[3]]['news_id'] : ''; ?>">
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(3, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[3]]['news_id']; }?>">
            ...
            <div class="row" style="padding-bottom: 10px"><!--small news loop...2 news per row-->
                <div class="col-md-3 col-lg-3">
                    ...
                    <?php //if (array_key_exists(4, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(4, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[4]]['news_id']; }?>">
                ...
                <div class="col-md-3 col-lg-3">
                    ...
                    <?php //if (array_key_exists(5, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(5, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[5]]['news_id']; }?>">
            ...
            <div class="row" style="padding-bottom: 10px"><!--small news loop...2 news per row-->
                <div class="col-md-3 col-lg-3">
                    ...
                    <?php //if (array_key_exists(6, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(6, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[6]]['news_id']; }?>">
                ...
                <div class="col-md-3 col-lg-3">
                    ...
                    <?php //if (array_key_exists(7, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(7, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[7]]['news_id']; }?>">
            ...
            <div class="row" style="padding-bottom: 10px; padding-top: 30px"><!--small news area-->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            ...
                            <?php //if (array_key_exists(8, $region_id_news_id_map)) : ?>
                                <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(8, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[8]]['news_id']; }?>">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <?php //if (array_key_exists(9, $region_id_news_id_map)) : ?>
                                <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(9, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[9]]['news_id']; }?>">
                                    <span class="cus_news_smallheadline">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            ...
                            <?php //if (array_key_exists(10, $region_id_news_id_map)) : ?>
                                <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(10, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[10]]['news_id']; }?>">
                                    <span class="cus_news_smallheadline">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <?php //if (array_key_exists(11, $region_id_news_id_map)) : ?>
                                <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(11, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[11]]['news_id']; }?>">
                                    <span class="cus_news_smallheadline">
                ...
                <div class="col-md-4 col-lg-4">
                    ...
                    <?php //if (array_key_exists(12, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists(12, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[12]]['news_id']; }?>">
            ...
            <div class ="row col-md-6 pull-right">
                <div class ="col-md-8" style="z-index: 600">
        ...
        <div class="row col-md-3" id="side_panel">
            <?php for($i=14;$i<18;$i++){?>
                <div class="col-md-12 col-lg-12">
                    ...
                    <?php //if (array_key_exists(1, $region_id_news_id_map)) : ?>
                        <a href="<?php echo base_url()?>applications/news_app/news_item/<?php if (array_key_exists($i-1, $region_id_news_id_map)){ echo $news_id_news_info_map[$region_id_news_id_map[$i-1]]['news_id']; }?>">
...
<script type="text/javascript">
    ...
    {
        var news_sub_category_id = <?php echo $sub_category_id;?>;
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url(); ?>' + "admin/newsapp/set_news_list_for_sub_category",
            data: {
