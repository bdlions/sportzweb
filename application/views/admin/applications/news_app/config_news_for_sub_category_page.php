<script type="text/javascript">
    $(function() {
        ...
        $("#button_submit_sub_category_page_configuration").click(function(){
            var news_sub_category_id = <?php echo $news_sub_category_info['news_sub_category_id'];?>;
            ...
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_news/save_news_subcategory_page_configuration",
                data: {
...
<div class="panel panel-default">
    <div class="panel-heading">
        <?php echo $news_sub_category_info['title'];?>
