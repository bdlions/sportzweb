    ...
    $(function() {
        $("#button_save_news").on("click", function() {
            ...
            if(selected_array.length == 1) {
                ...
                for(var i=1;i<=length;i++)
                {
                    ignore_array[i] = ($('#checkbox_'+i).prop('checked')===false)?0:1;
                }
                ...
                $('#modal_edit_news_item_for_category').modal('hide');
            } else {
...
<div class="modal fade" id="modal_edit_news_item_for_category" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
