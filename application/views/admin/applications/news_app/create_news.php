...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row form-horizontal form-background top-bottom-padding">  
            <form id="formsubmit" method="post" action="<?php echo base_url();?>admin/newsapp/create_news/<?php echo $news_category_id; ?>" onsubmit="return false;">
            <div class="row">
...
$(function () {
    $("#btnSubmit").on("click", function(){
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url();?>admin/newsapp/create_news/<?php echo $news_category_id;?>',
            data: $("#formsubmit").serializeArray(),
            success: function(data) {
                alert(data.message);
                window.location = '<?php echo base_url();?>admin/newsapp/create_news/<?php echo $news_category_id;?>';
            }
        });
    });
    
    // Change this to the location of your server-side upload handler:
    var url = "<?php echo base_url();?>admin/newsapp/create_news/<?php echo $news_category_id; ?>",
