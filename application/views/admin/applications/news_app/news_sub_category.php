...
<script type="text/x-tmpl" id="tmpl_news_sub_category_list">
    ...
    <tr>
        <td><a href="<?php echo base_url()."admin/newsapp/sub_category_news_list/{%= news_sub_category_info.id%}"; ?>">{%= news_sub_category_info.id%}</td>
        ...
        <td><a href="<?php echo base_url()."admin/newsapp/config_news_for_sub_category/{%=news_sub_category_info.id%}";?>">Config</a></td>
    </tr>
                        ...
                        <tbody id="tbody_news_sub_category_list">
                            <?php foreach($news_sub_category as $sub_category): ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url().'admin/newsapp/config_news_for_sub_category/'.$sub_category['id']?>">Config</a></td>
                                </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
    ...
    <div class="panel-body">
        <div class="row col-md-12">
            <div class="row form-group">
                ...
                <div class ="col-sm-3" style="padding-right: 0px;">
                    <a href="<?php echo base_url()."admin/newsapp/create_news/".$news['id'] ?>" >
                                ...
                                <?php foreach($news as $row): ?>
                                    <?php if(!empty($row)): ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url().'admin/newsapp/all_comments/'.$row[0]['id']?>">comments</a></td>
                                            <td><a href="<?php echo base_url().'admin/newsapp/edit_news/'.$row[0]['id']?>">Edit</a></td>
                                        </tr>
                                    <?php endif;?>
                                <?php endforeach;?>
                            <?php endif; ?>
