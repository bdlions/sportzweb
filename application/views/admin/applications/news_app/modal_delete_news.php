<script type="text/javascript">
    $(function() {
        $("#button_delete").on("click", function() {
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "admin/applications_news/delete_news",
                data: {
                    news_id: $("#input_news_id").val()
                },
    ...
    function open_modal_delete_confirm(news_id) {
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        ...
                        <label class="col-sm-10 control-label">Are you sure to delete this News?</label>
                        <input id="input_news_id" name="input_news_id" value="" type="hidden" class="form-control"/>
                    </div>
                </div>                
            </div>
