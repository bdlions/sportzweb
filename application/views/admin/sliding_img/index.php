...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#myCarousel').bind('slid.bs.carousel', function (e) {
            ...
            var edit_url = '<?php echo base_url(); ?>' +'admin/bg_sliding_img/edit_image'+current_img_id;
            var delete_url = '<?php echo base_url(); ?>' +'admin/bg_sliding_img/delete_image'+current_img_id;
                ...
                <div class="row col-md-10">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000">
                        ...
                        <a data-slide="next" href="#myCarousel">
                            <img id="imgbuttonf" class="imgbuttonf" onclick="get_current_image_id();" src="http://localhost/sportzweb/resources/images/frontArrow.png">
                        </a>
                        <a data-slide="prev" href="#myCarousel">
                            <img id="imgbuttonb" class="imgbuttonb" onclick="get_current_image_id();" src="http://localhost/sportzweb/resources/images/backArrow.png">
                        </a>
                    </div>
                </div>
                <div class="col-md-2" style="padding-left: 25px;"> </div>
            </div>-->
            ...
            <div class="row col-md-10">
                <div id="myCarousel" class="carousel slide" data-interval="3000" data-ride="carousel">
                    ...
                    <a href="#myCarousel" data-slide="next">
                        <img id="imgbuttonf" class="imgbuttonf" src="<?php echo base_url(); ?>resources/images/frontArrow.png" onclick="get_current_image_id();"/>
                    </a>
                    <a  href="#myCarousel" data-slide="prev">
                        <img id="imgbuttonb" class="imgbuttonb" src="<?php echo base_url(); ?>resources/images/backArrow.png" onclick="get_current_image_id();"/>
                    </a>
                </div>
            </div>
            
            <div class="col-md-2" style="padding-left: 25px;">
                    <a id="edit_current_image" href="<?php echo base_url().'admin/bg_sliding_img/edit_image/'.$image_list[0]['id']; ?>">Edit</a> &nbsp;&nbsp;| &nbsp;&nbsp;
                    <a onclick="open_modal_photo_delete_confirm(<?php echo $image_list[0]['id']; ?>)">Delete</a>
                    <!--<a id="delete_current_image" href="<?php echo base_url() . 'admin/bg_sliding_img/delete_image/'.$image_list[0]['id']; ?>">Delete</a>-->
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        $('#add_image_panel').on('click', function () {
            $('#add_image_panel').hide();
            $('#upload_image_panel').show();
        });
    });
</script>
<?php $this->load->view("admin/sliding_img/add_image");?>