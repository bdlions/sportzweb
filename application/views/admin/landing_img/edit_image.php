                ...
                <div class="row form-horizontal form-background top-bottom-padding">  
                    <div class="row">
                        <div class ="col-md-10 margin-top-bottom"> 
                            ...
                            <label class="col-lg-offset-1 col-md-offset-1 col-xs-offset-1 col-sm-offset-1">Please upload an image at least Height: 683px and Width: 1500px for better resolution</label>
                        </div>
                            <div class="form-group">
