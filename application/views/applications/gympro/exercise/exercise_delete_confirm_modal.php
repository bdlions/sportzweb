<script type="text/javascript">
    $(function() {
        $("#button_delete").on("click", function() {
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "applications/gympro/delete_exercise",
                data: {
    ...
    function open_modal_delete_confirm(exercise_id) {
        $('#input_exercise_id').val(exercise_id);
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        ...
                        <label class="col-sm-10 control-label">Are you sure to delete this Exercise?</label>
                        <input id="input_exercise_id" name="input_exercise_id" value="" type="hidden" class="form-control"/>
                    </div>
                </div>                
            </div>
