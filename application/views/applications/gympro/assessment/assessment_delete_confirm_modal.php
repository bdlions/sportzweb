<script type="text/javascript">
    $(function() {
        $("#button_delete").on("click", function() {
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "applications/gympro/delete_assessment",
                data: {
    ...
    function open_modal_delete_confirm(assessment_id) {
        $('#input_assessment_id').val(assessment_id);
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="row form-group">
                        ...
                        <label class="col-sm-10 control-label">Are you sure to delete this Assessment?</label>
                        <input id="input_assessment_id" name="input_assessment_id" value="" type="hidden" class="form-control"/>
                    </div>
                </div>                
            </div>
