...
<script>
    $(function () {
        ...
        $("#submit_create_group").on("click", function(){
            ...
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url();?>applications/gympro/create_group',
                data: $("#form_create_group").serialize()+"&selected_client_list=" + selected_client_list,
