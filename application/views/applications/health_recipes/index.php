                ...
                <?php if (count($recipe_view_list_item) > 1): ?>
                    <div class="col-md-8 grayborderbottom grayborderright">
                        <?php if (array_key_exists(0, $recipe_view_list_item)) : ?>
                            ...
                            <?php endif; ?>
                            <p class="image-caption reciepe_title" style="color: #7092BE"><?php echo (!empty($recipe_view_list_item[0]['title'])) ? $recipe_view_list_item[0]['title'] : ''; ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-4">
                        ...
                        <?php if (array_key_exists(1, $recipe_view_list_item)) : ?>
                            <a style="color: red" href="<?php echo base_url() . 'applications/healthy_recipes/recipe/' . $recipe_view_list_item[1]['id']; ?>">
                                <h2 class="reciepe_title"><?php echo (!empty($recipe_view_list_item[1]['title'])) ? $recipe_view_list_item[1]['title'] : ''; ?></h2>
                            </a>
            ...
            <div class="row">
                    ...
                    <div class="col-md-3 grayborderright">
                        <?php if (array_key_exists(2, $recipe_view_list_item)) : ?>
                            ...
                            <a style="color: red" href="<?php echo base_url() . 'applications/healthy_recipes/recipe/' . $recipe_view_list_item[2]['id']; ?>">
                                <h4 class="reciepe_title"><?php echo (!empty($recipe_view_list_item[2]['title'])) ? $recipe_view_list_item[2]['title'] : ''; ?></h4>
                            </a>
                            <span class="recipe_description">
                ...
                <div class="col-md-4 grayborderright">
                    <div class="purp_style_header">
                        <div class="col-md-12 purp_style">
                            Recipes
                        </div>
                    </div>  
                    <?php if (count($recipe_list_item) > 0): ?>
                        <?php foreach ($recipe_list_item as $key => $value): ?>
                            <a style="color: #B97A57; font-size: 16px;" href="<?php echo base_url() . 'applications/healthy_recipes/recipe/' . $value['id']; ?>">
                ...
                <div class="col-md-5 graybordertop">
                    <?php if (array_key_exists(3, $recipe_view_list_item)) : ?>
                        ...
                        <?php endif; ?>
                        <p class="reciepe_title" style="color: #7092BE; margin: 10px 0 15px 0;"><?php echo (!empty($recipe_view_list_item[3]['title'])) ? $recipe_view_list_item[3]['title'] : ''; ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                ...
                <?php if (array_key_exists(4, $recipe_view_list_item)) : ?>
                    <?php if (!empty($recipe_view_list_item[4]['main_picture'])): ?>
                        <a href="<?php echo base_url() . 'applications/healthy_recipes/recipe/' . $recipe_view_list_item[4]['id']; ?>">
                            ...
                            <p class="reciepe_title" style="margin: 10px 0 15px 0;"><?php echo (!empty($recipe_view_list_item[4]['title'])) ? $recipe_view_list_item[4]['title'] : ''; ?></p>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
                ...
                <?php if (array_key_exists(5, $recipe_view_list_item)) : ?>
                    <?php if (!empty($recipe_view_list_item[5]['main_picture'])): ?>
                        <a href="<?php echo base_url() . 'applications/healthy_recipes/recipe/' . $recipe_view_list_item[5]['id']; ?>">
                            ...
                            <p class="reciepe_title" style="margin: 10px 0 15px 0;"><?php echo (!empty($recipe_view_list_item[5]['title'])) ? $recipe_view_list_item[5]['title'] : ''; ?></p>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
                ...
                <?php if (array_key_exists(6, $recipe_view_list_item)) : ?>
                    <?php if (!empty($recipe_view_list_item[6]['main_picture'])): ?>
                        <a href="<?php echo base_url() . 'applications/healthy_recipes/recipe/' . $recipe_view_list_item[6]['id']; ?>">
                            ...
                            <p class="reciepe_title" style="margin: 10px 0 16px 0;"><?php echo (!empty($recipe_view_list_item[6]['title'])) ? $recipe_view_list_item[6]['title'] : ''; ?></p>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
