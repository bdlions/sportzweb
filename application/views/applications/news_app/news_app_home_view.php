...
<div class="col-md-9" style="padding-left: 0px; padding-right: 30px;">
    ...
    <div class="row" style="padding-bottom: 20px"><!--Greatest news-->
        <div class="col-md-6 col-lg-6">
            <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[0]]['id']; ?>"><img style="width:100%;" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[0]]['picture'] ?>"/></a>
        </div>
        <div class="col-md-6 col-lg-6">
        ...
        <?php for($i=1;$i<=3;$i++):?>
            <?php if (array_key_exists($i, $region_id_news_id_map) && array_key_exists($region_id_news_id_map[$i], $news_id_news_info_map)){ ?> 
                <div class="col-md-4 col-lg-4">
                    <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[$i]]['id']; ?>"><img style="width:100%;height: 150px;" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[$i]]['picture'] ?>"/></a>
                    <br>
    ...
    <div class="row" style="padding-bottom: 10px"><!--small news loop...2 news per row-->
        <?php if(array_key_exists(4, $region_id_news_id_map) && array_key_exists($region_id_news_id_map[4], $news_id_news_info_map)){?>
            <div class="col-md-3 col-lg-3">
                <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[4]]['id']; ?>"><img style="width:100%" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[4]]['picture'] ?>"/></a>
            </div>        
        ...
        <?php if(array_key_exists(5, $region_id_news_id_map) && array_key_exists($region_id_news_id_map[5], $news_id_news_info_map)){?>
            <div class="col-md-3 col-lg-3">
                <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[5]]['id']; ?>"><img style="width:100%" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[5]]['picture'] ?>"/></a>
            </div>
            <div class="col-md-3 col-lg-3" style="padding-left: 0px;">
    ...
    <?php if(array_key_exists(6, $region_id_news_id_map) && array_key_exists($region_id_news_id_map[6], $news_id_news_info_map)){?>
        <div class="col-md-3 col-lg-3">
            <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[6]]['id']; ?>"><img style="width:100%;" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[6]]['picture'] ?>"/></a>
        </div>
        <div class="col-md-3 col-lg-3" style="padding-left: 0px;">
    ...
    <?php if(array_key_exists(7, $region_id_news_id_map) && array_key_exists($region_id_news_id_map[7], $news_id_news_info_map)){?>
        <div class="col-md-3 col-lg-3">
            <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[7]]['id']; ?>"><img style="width:100%;" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[7]]['picture'] ?>"/></a>
        </div>
        <div class="col-md-3 col-lg-3" style="padding-left: 0px;">
    ...
    <div class="row" style="padding-bottom: 10px; padding-top: 30px"><!--small news area-->
        ...
        <div class="col-md-4 col-lg-4">
            <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[12]]['id']; ?>"><img style="width: 100%;" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[12]]['picture'] ?>"/></a>
...
<div class="col-md-3" id="side_panel">
    <?php for($fi=0;$fi<4;$fi++):?>
        <?php if(array_key_exists(13+$fi, $region_id_news_id_map) && array_key_exists($region_id_news_id_map[13+$fi], $news_id_news_info_map)){?>
            <div class="row" style="padding-bottom: 20px"><!--top news loop...3 news per row-->
                <a href="<?php echo base_url() . 'applications/news_app/news_item/'.$news_id_news_info_map[$region_id_news_id_map[13+$fi]]['id']; ?>"><img style="width:100%;" class="img-responsive" src="<?php echo base_url() . NEWS_IMAGE_PATH_W300_H150 . $news_id_news_info_map[$region_id_news_id_map[13+$fi]]['picture'] ?>"/></a>
                <br>
