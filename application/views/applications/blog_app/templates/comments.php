...
<script>
    ...
    function edit_your_comment(comment_id)
    {
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url(); ?>' + "applications/blog_app/edit_comment",
            data: {
    ...
    function remove_comment(id)
    {
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url(); ?>' + "applications/blog_app/remove_comment",
            data: {
                comment_id : id,
            },
            success: function(data) {
    ...
    function changeView()
    {
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url(); ?>' + "applications/blog_app/sorted_comment_list",
            data: {
                value: value,
              blog_id: blog_id
            },
...
<div class="row" style="margin-top: 8px;">
    <div class="col-md-12 cus_comment_box"><!--main box-->
        ...
        <div class="col-md-12" ><!--content-->
                ...
                <div class="row" style="margin-bottom: 8px"><!--comments-->
                    <div class="col-md-12">
                        <table style="margin-left: 16px">
                            <tbody id="tbody_blog_comments_list">
                            <tr>
                ...
                <div class="row" style="margin-bottom: 8px"><!--comments-->
                    <div class="col-md-12">
                        <table style="margin-left: 16px">
                            ...
                            <tr>
                                <td style="vertical-align: top">
                                    <img src="<?php echo base_url() . "resources/uploads/" . "London_eye.jpg"; ?>" height="auto" width="32px"/>
                                </td>
            ...
            <?php if($comment['rate_id'] == 2) : ?><!--negative comments-->
                <div class="row" style="margin-bottom: 8px"><!--comments-->
                    <div class="col-md-12">
                        <table style="margin-left: 16px">
                            <tbody id="tbody_blog_comments_list">
                                    ...
                                    <tr>
                                        <td style="width: 100%;"><!--actual comment-->
                                            ...
                                            <span class="cus_comment_field_commenter" style="color: #666666; font-weight: normal;">Comment</span>
                                                ...
                                                <input type="hidden" name="blog_id" id="blog_id" value="<?php echo isset($blog['id'])?$blog['id']:'';?>" >
                                                <!--<input type="hidden" name="user_id" id="user_id" value="<?php //echo $blog['id'];?>" >-->
...
<script type="text/javascript">
    $(function() {
        $("#save_comment").on("click", function() {
            ...
            //alert(comment_nature);
            
            $.ajax({
                dataType: 'json',
                type: "POST",
                url: '<?php echo base_url(); ?>' + "applications/blog_app/post_comment",
                data: {
                    comment: $("#comment").val(),
                    comment_nature : comment_nature,
                    blog_id : $("#blog_id").val()
...
<script type="text/x-tmpl" id="tmpl_blog_comments_list">
    {% var i=0, blog_comment_info = ((o instanceof Array) ? o[i++] : o); %}
    {% while(blog_comment_info){ %}
    <tr>
       
    </tr>
    {% blog_comment_info = ((o instanceof Array) ? o[i++] : null); %}
    {% } %}
</script>
