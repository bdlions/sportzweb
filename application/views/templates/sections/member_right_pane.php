                              ...
                              <div class="list-group-item right-panel-item">
                                    <div class="row">
                                        <div class="col-sm-4 col-md-4 col-xs-4 col-lg-4">
                                            <a href='<?php echo base_url() . "member_profile/show/" . $recent_activities[RECENT_ACTIVITIES_FIXTURES_RESULTS]['user_info']['user_id'] ?>' class="profile-name"> 
                                                <div>
                                                    ...
                                                    <div style="visibility:hidden;height:0px"><?php echo $recent_activities[RECENT_ACTIVITIES_FIXTURES_RESULTS]['user_info']['first_name'][0] . $recent_activities[RECENT_ACTIVITIES_FIXTURES_RESULTS]['user_info']['last_name'][0] ?></div>
                                                </div>
                                            </a>
                                        </div>
