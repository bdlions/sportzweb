...
class Admin_news{
    ...
    /*
     * This method will return news category page configuration info
     * @param $news_category_id, news category id
     * @Author Nazmul on 20th February 2015
     */
    public function get_news_category_page_configuration($news_category_id)
    {
        $show_advertise = 0;
        $region_id_news_id_map = array();
    ...
    /*
     * This method will return news sub category page configuration info
     * @param $news_sub_category_id, news sub category id
     * @Author Nazmul on 14th June 2014
     */
    public function get_news_sub_category_page_configuration($news_sub_category_id)
    {
        $show_advertise = 0;
        $region_id_news_id_map = array();
        $region_id_is_news_ignored_map = array();
