...
class Ion_auth {
    ...
    public function logged_in() {
        ...
        if(((bool)$user_id) == true){
            $this->ion_auth_model->update_last_activity_time($user_id);
        }
        return (bool) $user_id;
    }
    ...
    public function is_user_type($user_type){
    ...
    public function get_user_info($user_id = '')
    {
        ...
        $user_info_array = $this->get_users(array($user_id));
        if(!empty($user_info_array))
        {
            return $user_info_array[0];
        }
        else
        {
            return array();
    ...
    {
        $user_list = array();
        $user_list_array = $this->ion_auth_model->get_users($user_id_list)->result_array();
        foreach($user_list_array as $user_info)
        {
            ...
            $user_info['created_on'] = unix_to_human($created_on + $dateTime->getOffset());
            $user_list[] = $user_info;
        }
        return $user_list; 
    }
