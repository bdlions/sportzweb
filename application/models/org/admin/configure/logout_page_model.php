...
class Logout_page_model extends Ion_auth_model {
    ...
    /*
     * This method will add logout page configuration info
    ...
    public function add_configuration($additional_data)
    {
        ...
        $data = $this->_filter_data($this->tables['configure_logout_page'], $additional_data);        
        $this->db->insert($this->tables['configure_logout_page'], $data);
