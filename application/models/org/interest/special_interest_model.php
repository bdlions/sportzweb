 ...
 *
 */
class Special_interest_model extends CI_Model {
    ...
    public function add_all_special_interests($data)
    {
        $this->db->insert_batch('special_interests_types', $data);         
    }
    
    public function get_all_special_interests(){
        ...
        foreach ($result as $value) {
            $interests[] = array('id'=>$value->id, 'value' => $value->description, 'sub_interest' => json_decode($value->sub_category_list));
        }
        return $interests;
    }
}
